...
const searchData = async (name = '') => {
  ...
  const result = await new ProductService().getApplications(
  ...
  <div class="d-flex flex-column">
    <div class="d-flex flex-row align-center position-relative">
      <input
        ...
        :placeholder="$t('PRODUCT_SEARCH_APPLICATION_MODALITY_CAPTION')"
        type="text"
        @keyup="searchInput"
      />
      <img
    ...
    <div class="extend-items flex-grow-1">
      ...
      >
        <div class="d-flex align-center">
          <div class="icon">
            <AuthImage :height="70" :path="item.image?.url" :width="70" />
          </div>
          <div class="info">
